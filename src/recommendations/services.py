...
def get_recommendations(user_preferences: UserPreferences, items: list[Item], top_n: int = 10) -> list[Item]:
    ...
    ranked_items = [items[i]
                    for i, score in ranked_items if items[i].id not in user_preferences.watch_history]
